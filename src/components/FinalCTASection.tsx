      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center text-white">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 leading-tight">
            ...
            <span className="block text-2xl md:text-4xl mt-2 opacity-90">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
              ...
              <p className="opacity-90">Limited time offer - save big today!</p>
            </div>
            
            <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <Shield className="w-12 h-12 mx-auto mb-4 text-white" />
              <h3 className="text-xl font-bold mb-2">Safe & Effective</h3>
              <p className="opacity-90">Proven technology trusted by thousands</p>
            </div>
            
            <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <Heart className="w-12 h-12 mx-auto mb-4 text-white" />
              <h3 className="text-xl font-bold mb-2">Happy Pets</h3>
              <p className="opacity-90">Transform your relationship with your pet</p>
            </div>
          </div>
