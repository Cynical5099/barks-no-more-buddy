  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-hero-gradient text-white hover:shadow-lg hover:scale-105 transform transition-all duration-300 font-bold text-lg shadow-button",
        cta: "bg-warm-orange text-white hover:bg-warm-orange/90 font-bold shadow-button hover:shadow-lg hover:scale-105 transform transition-all duration-300",
        success: "bg-success-green text-white hover:bg-success-green/90 shadow-button",
      },
      size: {
